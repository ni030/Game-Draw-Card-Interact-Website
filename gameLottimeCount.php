...
mysqli_select_db($roywang21hb, $database_roywang21hb);
$query_DetailRS2 = sprintf("SELECT * FROM TaskLottime WHERE userID = %s", GetSQLValueString($colname_DetailRS1, "text"));
...
mysqli_select_db($roywang21hb, $database_roywang21hb); 
$query_A1 = sprintf("SELECT COUNT(*) FROM lottery WHERE userID= %s", GetSQLValueString($colname_DetailRS1, "text"));
...
if (isset($_SERVER['QUERY_STRING'])) {
  ...
  $updateGoTo = "lottery.php?recordID=".$colname_DetailRS1;
  if (isset($_SERVER['QUERY_STRING'])) {
