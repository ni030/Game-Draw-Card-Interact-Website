...
<P class="style7" align="center">用户信息列表</P>
<p class="style6">&nbsp;</p>
<table width="95%" height="" border="8" align="center" bordercolor="#13D669">
        ...
        <?php do { ?>
          <tr>
            <td height="20" align="left" class="style9"><a href="userConclude.php?recordID=<?php echo $row_Recordset1['nickname']; ?>"/><?php echo $row_Recordset1['nickname']; ?>&nbsp; </td>
            <td height="20" align="left" class="style9"><?php echo $row_Recordset1['name']; ?>&nbsp; </td>
            <td height="20" align="left" class="style9"><?php echo $row_Recordset1['phoneNum']; ?>&nbsp; </td>
            <td height="20" align="left" class="style9"><?php echo $row_Recordset1['gmail']; ?>&nbsp; </td>
            <td height="20" align="left" class="style9"><?php echo $row_Recordset1['address']; ?>&nbsp; </td>
            <td height="20" align="left" class="style9"><?php echo $row_Recordset1['poscode']; ?>&nbsp; </td>
            <td height="20" align="left" class="style9"><?php echo $row_Recordset1['negeri']; ?>&nbsp; </td>
