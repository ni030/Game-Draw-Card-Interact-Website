...
$total=2+$point1+$point2+$point3+$point4+$point5+$point6+$point7+$point8+$point9+$point10+$point11+$point12+$point13+$point14+$point15+$point16+$point18+$point19+$point20;
...
if (isset($_SERVER['QUERY_STRING'])) {
  ...
  $updateGoTo = "LottimeUpdateCount.php?recordID=".$userID;
  if (isset($_SERVER['QUERY_STRING'])) {
